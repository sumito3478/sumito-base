...
import info.sumito3478.HashCodable
import info.sumito3478.math.CityHash
import info.sumito3478.Dummy0
import org.apache.commons.lang3.text.WordUtils
import java.lang.Character.{ UnicodeBlock => JUnicodeBlock }
import info.sumito3478.collection.mutable.UnorderedMap
...
object UnicodeBlock {
  ...
  private[this] val blocksMap = {
    UnorderedMap[JUnicodeBlock, UnicodeBlock]((jblocks zip blocks): _*)
  }
...
abstract class UnicodeBlock extends HashCodable {
  protected val intern: JUnicodeBlock

  override def equals(that: Any): Boolean = that match {
    case that: UnicodeBlock => this.hashCode[Long] == that.hashCode[Long]
    case _ => false
  }

  private[this] val h = {
    CityHash.cityHash64(
      (classOf[UnicodeBlock].## << 32) | this.getClass.##)
  }
