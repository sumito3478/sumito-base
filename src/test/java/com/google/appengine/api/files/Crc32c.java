...
public final class Crc32c implements Checksum {
  ...
  private static final long[] CRC_TABLE = { 0x00000000, 0xf26b8303, 0xe13b70f7,
   ...
   *          the array of bytes.
   * @param off
   *          the offset into the array where the update should begin.
   * @param len
   *          the length of data to examine.
   */
  @Override
